...
const tools = [
  {
    ...
    icon: Users,
    href: '/staff/participant-manager',
    color: 'text-blue-600',
  },
  {
      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Welcome to the HRDC Staff Portal. Select a tool to get started.
          </p>
        </header>
